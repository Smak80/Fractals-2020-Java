    ...
    private void constructConsumer(){
        consumer = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                writer.addVideoStream(index, index, ICodec.ID.CODEC_ID_MPEG4, prefWidth, prefHeight);
                ...
                while(!consumerStop){
                    ...
                    for(var img : readyImg){
                        ...
                        writer.encodeVideo(index, corrImg, nextFrameTime, Global.DEFAULT_TIME_UNIT);
                        nextFrameTime += dt;
                    }
                }
                writer.close();
