...
public class ProportionsSaver {
    ...
    public ProportionsSaver( double XmaxPlane, double XminPlane, double YmaxPlane, double YminPlane,
    ...
    public void maintain(int NewPanelWidh, int NewPanelHaight ,CartesianScreenPlane plane){
    ...
    public void maintain(double xMin, double xMax, double yMin, double yMax, int PanelWidh,int PanelHaight, CartesianScreenPlane pplane){
        var pWidh =  xMax - xMin;
    ...
    public void maintain(CartesianScreenPlane plane, int NewPanelWidh, int NewPanelHaight){
        var kW = (float)NewPanelWidh/(float)wM;
        var kH = (float)NewPanelHaight/(float)hM;
        var ration0 = (float)NewPanelWidh/(float)NewPanelHaight;
        var ration = kW/kH;
